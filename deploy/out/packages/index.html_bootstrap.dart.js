...
$$._BaseSendPort = {"": "Object;_isolateId<",
  ...
  call$1: function(message) {
    ...
    port._liblib6$_callback = new $._BaseSendPort_call_anon(completer, port);
...
$$.Stream = {"": "Object;",
  ...
  get$last: function(_) {
    ...
    t3 = future.get$_setError();
    this.listen$4$cancelOnError$onDone$onError(t2, true, new $.Stream_last_anon0(t1, future), t3);
    return future;
  },
  elementAt$1: function(_, index) {
    var t1, t2, future, t3;
...
$$.Stream_last_anon0 = {"": "Closure;box_0,future_1",
  call$0: function() {
    ...
    this.future_1._setError$1($.StateError$("No elements"));
  },
  $isFunction: true
};
...
$$._ForwardingStreamSubscription = {"": "_BaseStreamSubscription;_stream,_cancelOnError<,_liblib7$_subscription@,_onData,_onError,_onDone",
  cancel$0: function() {
...
$$._EventStreamSubscription = {"": "StreamSubscription;_pauseCount,_target,_eventType,_liblib8$_onData,_useCapture",
  cancel$0: function() {
...
$$._WrappedEvent = {"": "Object;",
  get$currentTarget: function(_) {
    return $.get$currentTarget$x(this.wrapped);
  },
  get$timeStamp: function(_) {
    return $.get$timeStamp$x(this.wrapped);
  },
  get$type: function(_) {
...
$$._WrappedList = {"": "ListBase;_liblib8$_list",
  get$iterator: function(_) {
    return $._WrappedIterator$($.get$iterator$ax(this._liblib8$_list));
  },
  get$length: function(_) {
...
$$._AttributeClassSet = {"": "CssClassSet;_liblib5$_element",
  readClasses$0: function() {
    ...
    classname = $.get$attributes$x(this._liblib5$_element)._element.getAttribute("class");
    s = $.LinkedHashSet$($.JSString);
    if (classname == null)
      return s;
...
$$.Document = {"": "Observable;__$_title,__$_content,__$created,__$modified,__$id,$$_observers,$$_changes,hashCode",
  get$_title: function() {
    if ($.observeReads() === true)
      $.notifyRead(this, 1, "_title");
    return this.__$_title;
  },
  set$_title: function(value) {
    if ($.hasObservers(this))
      $.notifyChange(this, 1, "_title", this.__$_title, value);
    this.__$_title = value;
  },
  get$_content: function() {
    if ($.observeReads() === true)
      $.notifyRead(this, 1, "_content");
    return this.__$_content;
  },
  set$_content: function(value) {
    if ($.hasObservers(this))
      $.notifyChange(this, 1, "_content", this.__$_content, value);
    this.__$_content = value;
  },
  get$created: function() {
    if ($.observeReads() === true)
      $.notifyRead(this, 1, "created");
    return this.__$created;
  },
  created$0: function() {
    return this.get$created().call$0();
  },
  set$created: function(value) {
    if ($.hasObservers(this))
      $.notifyChange(this, 1, "created", this.__$created, value);
    this.__$created = value;
  },
  get$modified: function() {
    if ($.observeReads() === true)
      $.notifyRead(this, 1, "modified");
    return this.__$modified;
  },
  set$modified: function(value) {
    if ($.hasObservers(this))
      $.notifyChange(this, 1, "modified", this.__$modified, value);
    this.__$modified = value;
  },
  get$id: function(_) {
    if ($.observeReads() === true)
      $.notifyRead(this, 1, "id");
    return this.__$id;
  },
  ...
  toJson$0: function() {
    var data, output;
    data = $.makeLiteralMap(["id", this.get$id(this), "title", this.get$_title(), "content", this.get$_content(), "created", $.toString$0(this.get$created()), "modified", $.toString$0(this.get$modified())]);
    output = $.StringBuffer$("");
    $._JsonStringifier$(output).stringifyValue$1(data);
    return output._contents;
  },
  get$wordCount: function() {
    var count = $.get$length$asx($.allMatches$1$s($.RegExp_RegExp("(\\w|\\')+", true, false), this.get$_content()));
    if ($.$eq(count, 1) === true)
      return $.S(count) + " word";
    return $.S(count) + " words";
  },
  set$title: function(_, title) {
    this.set$_title(title);
    this.set$modified($.DateTime_DateTime$now());
  },
  ...
  Document$fromJson$1: function(json) {
    var data, t1;
    data = $.parse(json, null);
    t1 = $.getInterceptor$asx(data);
    this.set$id(this, t1.$index(data, "id"));
    this.set$_title(t1.$index(data, "title"));
    this.set$_content(t1.$index(data, "content"));
    this.set$created($.DateTime_parse(t1.$index(data, "created")));
    this.set$modified($.DateTime_parse(t1.$index(data, "modified")));
  },
  Document$2: function(_title, _content) {
    this.set$id(this, "document-" + $.Random_Random(null).nextInt$1(1000000));
    this.set$created($.DateTime_DateTime$now());
    this.set$modified($.DateTime_DateTime$now());
  }
};
...
$$.init_autogenerated_anon = {"": "Closure;",
  call$1: function($$event) {
    var doc = $.Document$("Untitled", "");
    $.add$1$ax($.get$documents(), doc);
    $.selectDocument(doc, null, false);
  },
  $isFunction: true
};

$$.init_autogenerated_anon0 = {"": "Closure;box_2",
  call$1: function($$event) {
    var t1 = $.get$value$x(this.box_2.__e1_3);
    $.searchFilter(t1);
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon1 = {"": "Closure;",
  call$0: function() {
    if ($.observeReads() === true)
      $.notifyRead($.get$__changes0(), 1, "searchFilter");
    return $.__$searchFilter;
  },
  $isFunction: true
};

$$.init_autogenerated_anon2 = {"": "Closure;box_2",
  call$1: function(e) {
    var t1 = this.box_2;
    if ($.$eq($.get$value$x(t1.__e1_3), e) !== true)
      $.set$value$x(t1.__e1_3, e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon4 = {"": "Closure;__html0_3,__html1_4",
  call$3: function($$list, $$index, __t) {
    var doc, __e3;
    doc = $.$index$asx($$list, $$index);
    __e3 = $.clone$1$x(this.__html0_3, true);
    __t.conditional$3(__e3, new $.init_autogenerated__anon9(doc), new $.init_autogenerated__anon10(this.__html1_4, doc));
    $.addAll$1$ax(__t, [document.createTextNode("\n\n          "), document.createTextNode("\n          "), __e3, document.createTextNode("\n\n        ")]);
  },
  $isFunction: true
};

$$.init_autogenerated__anon9 = {"": "Closure;doc_5",
  call$0: function() {
    return $.matchesSearchFilter(this.doc_5);
  },
  $isFunction: true
};

$$.init_autogenerated__anon10 = {"": "Closure;__html1_6,doc_7",
  call$1: function(__t) {
    var t1, t2, t3;
    t1 = {};
    t1.__e2_0 = null;
    t1.__e2_0 = $.clone$1$x(this.__html1_6, true);
    t2 = $.get$onClick$x(t1.__e2_0);
    t3 = this.doc_7;
    __t.listen$2(t2, new $.init_autogenerated___anon(t3));
    __t.listen$2($.get$onTouchCancel$x(t1.__e2_0), new $.init_autogenerated___anon0());
    __t.listen$2($.get$onTouchEnd$x(t1.__e2_0), new $.init_autogenerated___anon1(t3));
    __t.listen$2($.get$onTouchLeave$x(t1.__e2_0), new $.init_autogenerated___anon2());
    __t.listen$2($.get$onTouchMove$x(t1.__e2_0), new $.init_autogenerated___anon3());
    __t.listen$2($.get$onTouchStart$x(t1.__e2_0), new $.init_autogenerated___anon4(t3));
    __t.oneWayBind$4(new $.init_autogenerated___anon5(t3), new $.init_autogenerated___anon6(t1), false, false);
    t3 = $.DocumentItem$();
...
$$.init_autogenerated___anon = {"": "Closure;doc_8",
  call$1: function($$event) {
    $.selectDocument(this.doc_8, $$event, true);
  },
  $isFunction: true
};
...
$$.init_autogenerated___anon1 = {"": "Closure;doc_9",
  call$1: function($$event) {
    $.touchEnd($$event, this.doc_9);
  },
  $isFunction: true
};
...
$$.init_autogenerated___anon4 = {"": "Closure;doc_10",
  call$1: function($$event) {
    var t1;
    this.doc_10;
    t1 = $.getInterceptor$x($$event);
    $.add$1$ax($.get$classes$x(t1.get$currentTarget($$event)), "touched");
    t1 = t1.get$timeStamp($$event);
    $._startTime(t1);
  },
  $isFunction: true
};

$$.init_autogenerated___anon5 = {"": "Closure;doc_11",
  call$0: function() {
    return this.doc_11;
  },
  $isFunction: true
...
$$.init_autogenerated___anon6 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$xtag$x(t1.__e2_0).get$doc(), e) !== true)
      $.get$xtag$x(t1.__e2_0).set$doc(e);
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon6 = {"": "Closure;",
  call$0: function() {
    if ($.observeReads() === true)
      $.notifyRead($.get$__changes(), 1, "activeDocument");
    return $.get$__$activeDocument() != null;
  },
  $isFunction: true
};

$$.init_autogenerated_anon7 = {"": "Closure;__html2_12,__html3_13,__html4_14",
  call$1: function(__t) {
    var t1, __e8, t2, __e11, __binding10;
    t1 = {};
    t1.__e7_1 = null;
    t1.__e9_2 = null;
    __e8 = $.clone$1$x(this.__html2_12, true);
    t2 = $.getInterceptor$x(__e8);
    __t.listen$2($.get$onClick$x($.$index$asx(t2.get$nodes(__e8), 3)), new $.init_autogenerated__anon());
    t1.__e7_1 = $.$index$asx($.get$nodes$x($.$index$asx(t2.get$nodes(__e8), 7)), 3);
    __t.listen$2($.get$onInput$x(t1.__e7_1), new $.init_autogenerated__anon0(t1));
    __t.listen$2($.get$onKeyUp$x(t1.__e7_1), new $.init_autogenerated__anon1());
    __t.oneWayBind$4(new $.init_autogenerated__anon2(), new $.init_autogenerated__anon3(t1), false, false);
    t1.__e9_2 = $.clone$1$x(this.__html3_13, true);
    __t.listen$2($.get$onInput$x(t1.__e9_2), new $.init_autogenerated__anon4(t1));
    __t.listen$2($.get$onKeyUp$x(t1.__e9_2), new $.init_autogenerated__anon5());
    __t.oneWayBind$4(new $.init_autogenerated__anon6(), new $.init_autogenerated__anon7(t1), false, false);
    __e11 = $.clone$1$x(this.__html4_14, true);
    __binding10 = __t.contentBind$2(new $.init_autogenerated__anon8(), false);
    $.addAll$1$ax($.get$nodes$x(__e11), [document.createTextNode("\n\n          "), document.createTextNode("\n          "), __binding10, document.createTextNode("\n\n        ")]);
    $.addAll$1$ax(__t, [document.createTextNode("\n\n        "), __e8, document.createTextNode("\n\n        "), document.createTextNode("\n        "), t1.__e9_2, document.createTextNode("\n\n        "), __e11, document.createTextNode("\n      ")]);
  },
  $isFunction: true
};
...
$$.init_autogenerated__anon = {"": "Closure;",
  call$1: function($$event) {
    $.contentActive0(false);
  },
  $isFunction: true
};

$$.init_autogenerated__anon0 = {"": "Closure;box_1",
  call$1: function($$event) {
    if ($.observeReads() === true)
      $.notifyRead($.get$__changes(), 1, "activeDocument");
    $.set$title$x($.get$__$activeDocument(), $.get$value$x(this.box_1.__e7_1));
  },
  $isFunction: true
};
...
$$.init_autogenerated__anon1 = {"": "Closure;",
  call$1: function($$event) {
    ...
    if ($.observeReads() === true)
      $.notifyRead($.get$__changes(), 1, "activeDocument");
    $.saveDocument($.get$__$activeDocument());
  },
  $isFunction: true
};
...
$$.init_autogenerated__anon2 = {"": "Closure;",
  call$0: function() {
    if ($.observeReads() === true)
      $.notifyRead($.get$__changes(), 1, "activeDocument");
    return $.get$title$x($.get$__$activeDocument());
  },
  $isFunction: true
};
...
$$.init_autogenerated__anon3 = {"": "Closure;box_1",
  call$1: function(e) {
    var t1 = this.box_1;
    if ($.$eq($.get$value$x(t1.__e7_1), e) !== true)
...
$$.init_autogenerated__anon4 = {"": "Closure;box_1",
  call$1: function($$event) {
    if ($.observeReads() === true)
      $.notifyRead($.get$__changes(), 1, "activeDocument");
    $.set$content$x($.get$__$activeDocument(), $.get$value$x(this.box_1.__e9_2));
  },
  $isFunction: true
};
...
$$.init_autogenerated__anon6 = {"": "Closure;",
  call$0: function() {
    if ($.observeReads() === true)
      $.notifyRead($.get$__changes(), 1, "activeDocument");
    return $.get$content$x($.get$__$activeDocument());
  },
  $isFunction: true
};
...
$$.init_autogenerated__anon7 = {"": "Closure;box_1",
  call$1: function(e) {
    var t1 = this.box_1;
    if ($.$eq($.get$value$x(t1.__e9_2), e) !== true)
      $.set$value$x(t1.__e9_2, e);
  },
  $isFunction: true
};
...
$$.init_autogenerated__anon8 = {"": "Closure;",
  call$0: function() {
    if ($.observeReads() === true)
      $.notifyRead($.get$__changes(), 1, "activeDocument");
    return $.get$__$activeDocument().get$wordCount();
  },
  $isFunction: true
};
...
$$.DocumentItem = {"": "WebComponent;_liblib9$_root,__e18,__e15,__e17,__e19,__t,doc@,_host,_shadowRoots",
  created_autogenerated$0: function() {
    var t1, __binding14, __binding16, t2, t3;
    this._liblib9$_root = this.createShadowRoot$0(this);
    this.__t = $.Template$(this._liblib9$_root);
    t1 = this._liblib9$_root;
    if (typeof t1 === "object" && t1 !== null && !!$.getInterceptor(t1).$isShadowRoot)
      $.set$applyAuthorStyles$x(t1, true);
    $.add$1$ax($.get$nodes$x(this._liblib9$_root), $.clone$1$x($.get$DocumentItem___shadowTemplate(), true));
    this.__e19 = $.$index$asx($.get$nodes$x(this._liblib9$_root), 1);
    this.__e15 = $.$index$asx($.get$nodes$x(this.__e19), 1);
    __binding14 = this.__t.contentBind$2(new $.DocumentItem_created_autogenerated_anon(this), false);
    $.add$1$ax($.get$nodes$x(this.__e15), __binding14);
    this.__e17 = $.$index$asx($.get$nodes$x(this.__e19), 3);
    __binding16 = this.__t.contentBind$2(new $.DocumentItem_created_autogenerated_anon0(this), false);
    $.add$1$ax($.get$nodes$x(this.__e17), __binding16);
    this.__e18 = $.$index$asx($.get$nodes$x(this.__e19), 7);
    this.__t.listen$2($.get$onClick$x(this.__e18), new $.DocumentItem_created_autogenerated_anon1(this));
    t1 = this.__t;
    t2 = this.__e19;
    t3 = new $.DocumentItem_created_autogenerated_anon2(this);
    t1.children.push($.ClassAttrBinding$(t2, t3, false));
    this.__t.create$0();
  },
  ...
  get$title: function(_) {
    return $.get$isEmpty$asx($.get$title$x(this.doc)) === true ? "Untitled" : $.get$title$x(this.doc);
  },
  get$modified: function() {
    var t1 = $.get$dateFormat();
    return t1.format$1(t1, this.doc.get$modified());
  },
  get$isActiveClass: function() {
    return $.$eq(this.doc, $.activeDocument()) === true ? "active" : "";
  }
};

$$.DocumentItem_created_autogenerated_anon = {"": "Closure;this_0",
  call$0: function() {
...
$$.DocumentItem_created_autogenerated_anon0 = {"": "Closure;this_1",
  call$0: function() {
    return this.this_1.get$modified();
  },
  $isFunction: true
};

$$.DocumentItem_created_autogenerated_anon1 = {"": "Closure;this_2",
  call$1: function($$event) {
    var t1, t2, t3, output;
    t1 = this.this_2.get$doc();
    $.remove$1$ax($.get$documents(), t1);
    t2 = $.getInterceptor$x(t1);
    $.remove$1$ax($.get$_storedIds(), t2.get$id(t1));
    ...
    t3 = $.get$_storedIds();
    output = $.StringBuffer$("");
    $._JsonStringifier$(output).stringifyValue$1(t3);
    $.$indexSet$ax(t1, "writer-document-id", output.toString$0(output));
  },
  $isFunction: true
};

$$.DocumentItem_created_autogenerated_anon2 = {"": "Closure;this_3",
  call$0: function() {
    return this.this_3.get$isActiveClass();
  },
  $isFunction: true
};

$$.DateFormat = {"": "Object;_locale,_liblib11$_pattern,_formatFieldsPrivate",
  ...
  add_jm$0: function() {
    return this.addPattern$1("jm");
  },
  get$_formatFields: function() {
    if (this._formatFieldsPrivate == null) {
      if (this._liblib11$_pattern == null)
        this._useDefaultPattern$0();
      this._formatFieldsPrivate = this.parsePattern$1(this._liblib11$_pattern);
    }
  ...
  addPattern$2: function(inputPattern, separator) {
    ...
    if ($.containsKey$1$x(this.get$_availableSkeletons(), inputPattern) !== true) {
      t1 = this._liblib11$_pattern;
      if (t1 == null)
        this._liblib11$_pattern = inputPattern;
      else
        this._liblib11$_pattern = $.S(t1) + separator + $.S(inputPattern);
    } else {
      t1 = $.$index$asx(this.get$_availableSkeletons(), inputPattern);
      t2 = this._liblib11$_pattern;
      if (t2 == null)
        this._liblib11$_pattern = t1;
      else
        this._liblib11$_pattern = $.S(t2) + separator + $.S(t1);
    }
    return this;
  },
...
$$.ObservableList = {"": "ListMixinWorkaround_Observable;_liblib10$_list,$$_observers,$$_changes,hashCode",
  ...
  toString$0: function(_) {
    ...
    return $.JSArray_methods.toString$0(this._liblib10$_list);
  },
...
$$._ExpressionObserver = {"": "Object;_id<,_expression,_callback,_debugName,_reads,_unobservers,_scheduled@,_liblib2$_value",
  ...
  _addRead$3: function(target, type, key) {
    ...
    t1 = this._reads;
    reads = t1.putIfAbsent$2(t1, target, new $._ExpressionObserver__addRead_anon());
    try {
...
$$.WebComponent = {"": "Object;",
  ...
  get$onTouchCancel: function(_) {
    return $.get$onTouchCancel$x(this.get$host(this));
  },
  get$onTouchEnd: function(_) {
    return $.get$onTouchEnd$x(this.get$host(this));
  },
  get$onTouchLeave: function(_) {
    return $.get$onTouchLeave$x(this.get$host(this));
  },
  get$onTouchMove: function(_) {
    return $.get$onTouchMove$x(this.get$host(this));
  },
  get$onTouchStart: function(_) {
    return $.get$onTouchStart$x(this.get$host(this));
  },
  $isElement: true,
  $asElement: null,
  $isNode: true,
...
$$.TemplateElement = {"": "Element;content="};
...
$.DateTime_parse = function(formattedString) {
  ...
  match = $.JSSyntaxRegExp$("^([+-]?\\d?\\d\\d\\d\\d)-?(\\d\\d)-?(\\d\\d)(?:[ T](\\d\\d)(?::?(\\d\\d)(?::?(\\d\\d)(.\\d{1,6})?)?)? ?([zZ])?)?$", true, false).firstMatch$1(formattedString);
  if (match != null) {
    ...
    if (1 >= t3.length)
      throw $.ioore(1);
    years = $.Primitives_parseInt(t3[1], null, null);
    if (2 >= t3.length)
      throw $.ioore(2);
    month = $.Primitives_parseInt(t3[2], null, null);
    if (3 >= t3.length)
      throw $.ioore(3);
    day = $.Primitives_parseInt(t3[3], null, null);
    if (4 >= t3.length)
      throw $.ioore(4);
    hour = t1.call$1(t3[4]);
    if (5 >= t3.length)
      throw $.ioore(5);
    minute = t1.call$1(t3[5]);
    if (6 >= t3.length)
      throw $.ioore(6);
    second = t1.call$1(t3[6]);
    if (7 >= t3.length)
      throw $.ioore(7);
    millisecond = $.round$0$n($.$mul$n(t2.call$1(t3[7]), 1000));
    if (millisecond === 1000) {
...
$.Document$ = function(_title, _content) {
  var t1 = $.$add$ns($.Observable_$_nextHashCode, 1);
  $.Observable_$_nextHashCode = t1;
  t1 = new $.Document(_title, _content, null, null, null, null, null, t1);
  t1.Document$2(_title, _content);
  return t1;
};
...
$.Document$fromJson = function(json) {
  var t1 = $.$add$ns($.Observable_$_nextHashCode, 1);
  $.Observable_$_nextHashCode = t1;
  t1 = new $.Document(null, null, null, null, null, null, null, t1);
  t1.Document$fromJson$1(json);
  return t1;
};

$.searchFilter = function(value) {
  if ($.hasObservers($.get$__changes0()))
    $.notifyChange($.get$__changes0(), 1, "searchFilter", $.__$searchFilter, value);
  $.__$searchFilter = value;
};

$.matchesSearchFilter = function(doc) {
  var t1, t2;
  if ($.observeReads() === true)
    $.notifyRead($.get$__changes0(), 1, "searchFilter");
  if ($.get$isEmpty$asx($.__$searchFilter) === true)
    return true;
  t1 = $.getInterceptor$x(doc);
  t2 = $.toLowerCase$0$s(t1.get$title(doc));
  if ($.observeReads() === true)
    $.notifyRead($.get$__changes0(), 1, "searchFilter");
  if ($.JSString_methods.contains$1(t2, $.toLowerCase$0$s($.__$searchFilter)) !== true) {
    t1 = $.toLowerCase$0$s(t1.get$content(doc));
    if ($.observeReads() === true)
      $.notifyRead($.get$__changes0(), 1, "searchFilter");
    t1 = $.JSString_methods.contains$1(t1, $.toLowerCase$0$s($.__$searchFilter)) === true;
  } else
    t1 = true;
  return t1;
};
...
$.saveDocument = function(doc) {
  var t1, t2, output;
  t1 = $.getInterceptor$x(doc);
  $.$indexSet$ax(window.localStorage, t1.get$id(doc), doc.toJson$0());
  if ($.contains$1$asx($.get$_storedIds(), t1.get$id(doc)) !== true)
    $.add$1$ax($.get$_storedIds(), t1.get$id(doc));
  t1 = window.localStorage;
  t2 = $.get$_storedIds();
  output = $.StringBuffer$("");
  $._JsonStringifier$(output).stringifyValue$1(t2);
  $.$indexSet$ax(t1, "writer-document-id", output._contents);
};

$._fetchDocument = function(id) {
  return $.Document$fromJson(window.localStorage.getItem(id));
};

$.activeDocument = function() {
  if ($.observeReads() === true)
    $.notifyRead($.get$__changes(), 1, "activeDocument");
  return $.get$__$activeDocument();
};

$.activeDocument0 = function(value) {
  if ($.hasObservers($.get$__changes()))
    $.notifyChange($.get$__changes(), 1, "activeDocument", $.get$__$activeDocument(), value);
  $.__$activeDocument = value;
};

$.contentActive = function() {
  if ($.observeReads() === true)
    $.notifyRead($.get$__changes(), 1, "contentActive");
  return $.__$contentActive;
};

$.contentActive0 = function(value) {
  if ($.hasObservers($.get$__changes()))
    $.notifyChange($.get$__changes(), 1, "contentActive", $.__$contentActive, value);
  $.__$contentActive = value;
};

$.selectDocument = function(doc, $event, markActive) {
  var t1, t2;
  if ($.get$isEmpty$asx($.get$documents()) === true)
    $.activeDocument0(null);
  else {
    t1 = $.getInterceptor(doc);
    if (doc != null)
      if ($.contains$1$asx($.get$documents(), doc) === true) {
        if ($.observeReads() === true)
          $.notifyRead($.get$__changes(), 1, "activeDocument");
        t2 = t1.$eq(doc, $.get$__$activeDocument()) !== true;
      } else
        t2 = false;
    else
      t2 = false;
    if (t2)
      ...
      if ($.observeReads() === true)
        $.notifyRead($.get$__changes(), 1, "activeDocument");
      if ($.get$__$activeDocument() != null) {
        t2 = $.get$documents();
        if ($.observeReads() === true)
          $.notifyRead($.get$__changes(), 1, "activeDocument");
        t2 = $.contains$1$asx(t2, $.get$__$activeDocument()) === true;
      } else
        t2 = false;
      if (t2) {
        if (markActive) {
          if ($.observeReads() === true)
            $.notifyRead($.get$__changes(), 1, "activeDocument");
          t1 = t1.$eq(doc, $.get$__$activeDocument()) === true;
        } else
          t1 = false;
        $.contentActive0(t1);
      } else {
        t1 = $.get$last$ax($.get$documents());
        $.activeDocument0(t1);
      }
    }
  }
...
$._startTime = function(value) {
  if ($.hasObservers($.get$__changes()))
    $.notifyChange($.get$__changes(), 1, "_startTime", $.__$_startTime, value);
  $.__$_startTime = value;
};

$.touchEnd = function($event, doc) {
  var t1, t2;
  t1 = $.getInterceptor$x($event);
  $.remove$1$ax($.get$classes$x(t1.get$currentTarget($event)), "touched");
  t2 = t1.get$timeStamp($event);
  if ($.observeReads() === true)
    $.notifyRead($.get$__changes(), 1, "_startTime");
  if ($.$gt$n(t2, $.$add$ns($.__$_startTime, 700))) {
    t1.preventDefault$0($event);
    t1 = $.getInterceptor$x(doc);
    $.set$href$x($.Window_methods.get$location(window), "mailto:?to=&subject=Document: " + $.S(t1.get$title(doc)) + "&body=" + $.S(t1.get$content(doc)) + "%0D%0A%0D%0A%0D%0AThis e-mail was written with The Dart Web Writer!%0D%0A%0D%0AThanks for trying out the codelab!%0D%0Awww.dartlang.org");
  }
};

$.init_autogenerated = function() {
  var t1, _root, __html0, __html1, __html2, __html3, __html4, __t, t2, t3, __e5, t4, __e13;
  t1 = {};
  _root = document.body;
  __html0 = document.createElement("template");
  __html1 = $._ElementFactoryProvider_createElement_html("<div is=\"x-document-item\"></div>");
  __html2 = $._ElementFactoryProvider_createElement_html("<div class=\"title\">\n          <!-- Button to go back to document list.\n               Only visible in a small viewport. -->\n          <button>&lt;</button>\n\n          <!-- Document title -->\n          <div class=\"input-wrap\">\n\n            <!-- STEP 5: Add event handler to save the active document. -->\n            <input type=\"text\">\n          </div>\n        </div>");
  __html3 = $._ElementFactoryProvider_createElement_html("<textarea class=\"content\"></textarea>");
  __html4 = $._ElementFactoryProvider_createElement_html("<div class=\"footer\"></div>");
  t1.__e1_3 = null;
  __t = $.Template$(_root);
  t2 = $.getInterceptor$x(_root);
  t3 = t2.get$nodes(_root)._this.childNodes;
  if (3 >= t3.length)
    throw $.ioore(3);
  __e5 = t3[3];
  t3 = $.getInterceptor$x(__e5);
  __t.listen$2($.get$onClick$x($.$index$asx($.get$nodes$x($.$index$asx(t3.get$nodes(__e5), 1)), 3)), new $.init_autogenerated_anon());
  t1.__e1_3 = $.$index$asx($.get$nodes$x($.$index$asx($.get$nodes$x($.$index$asx(t3.get$nodes(__e5), 1)), 5)), 3);
  __t.listen$2($.get$onInput$x(t1.__e1_3), new $.init_autogenerated_anon0(t1));
  t4 = __t.children;
  t4.push($.DomPropertyBinding$(new $.init_autogenerated_anon1(), new $.init_autogenerated_anon2(t1), false, false));
  t4.push($.LoopTemplate$($.$index$asx($.get$nodes$x($.$index$asx(t3.get$nodes(__e5), 5)), 3), new $.init_autogenerated_anon3(), new $.init_autogenerated_anon4(__html0, __html1)));
  t4.push($.ClassAttrBinding$(__e5, new $.init_autogenerated_anon5(), false));
  t2 = t2.get$nodes(_root)._this.childNodes;
  if (7 >= t2.length)
    throw $.ioore(7);
  __e13 = t2[7];
  t4.push($.ConditionalTemplate$($.$index$asx($.get$nodes$x(__e13), 3), new $.init_autogenerated_anon6(), new $.init_autogenerated_anon7(__html2, __html3, __html4)));
  t4.push($.ClassAttrBinding$(__e13, new $.init_autogenerated_anon8(), false));
  __t.create$0();
  __t.insert$0(__t);
};

$.DocumentItem$ = function() {
  return new $.DocumentItem(null, null, null, null, null, null, null, null, null);
};
...
$.main = function() {
  ...
  $.useObservers = true;
  t1 = $.get$documents();
  if (window.localStorage.getItem("writer-document-id") != null)
    $._storedIds = $.parse(window.localStorage.getItem("writer-document-id"), null);
  $.addAll$1$ax(t1, $.map$1$ax($.get$_storedIds(), $._fetchDocument));
  if ($.get$isEmpty$asx($.get$documents()) === true) {
    doc = $.Document$("Untitled", "");
    $.add$1$ax($.get$documents(), doc);
    $.selectDocument(doc, null, false);
  }
  $.selectDocument($.get$first$ax($.get$documents()), null, false);
  $.init_autogenerated();
};

$.DateFormat$MMMMd = function(locale) {
  var t1 = new $.DateFormat(null, null, null);
  t1.DateFormat$2("MMMMd", locale);
  return t1;
};
...
$.Intl__shortLocale = function(aLocale) {
  ...
  if ($.$lt$n(t1.get$length(aLocale), 2))
    return aLocale;
...
$.Intl_canonicalizedLocale = function(aLocale) {
  ...
  if (t1.$eq(aLocale, "C") === true)
    return "en_ISO";
  if ($.$lt$n(t1.get$length(aLocale), 5) || $.$gt$n(t1.get$length(aLocale), 6))
    return aLocale;
...
$.deliverChangesSync = function() {
  ...
  while (true) {
    ...
    if (changedExpressions != null)
      changedExpressions.forEach$1(changedExpressions, new $.deliverChangesSync_anon());
...
$.setImmediate = function(callback) {
  ...
  port._liblib6$_callback = new $.setImmediate_anon(callback, port);
...
$._fetchDocument.call$1 = $._fetchDocument;
$._fetchDocument.$name = "_fetchDocument";
...
$.set$applyAuthorStyles$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$applyAuthorStyles(receiver, value);
};
...
Isolate.$lazy($, "dateFormat", "dateFormat", "get$dateFormat", function() {
  return $.DateFormat$MMMMd(null).addPattern$2("", ", ").add_jm$0();
});
Isolate.$lazy($, "__changes", "__changes0", "get$__changes0", function() {
  return $.Observable$();
});
Isolate.$lazy($, "_storedIds", "_storedIds", "get$_storedIds", function() {
  return [];
});
Isolate.$lazy($, "documents", "documents", "get$documents", function() {
  return $.toObservable([]);
});
Isolate.$lazy($, "__changes", "__changes", "get$__changes", function() {
  return $.Observable$();
});
Isolate.$lazy($, "__$activeDocument", "__$activeDocument", "get$__$activeDocument", function() {
  return $.Document$("Hello Codelab!", "Try typing in this document!");
});
Isolate.$lazy($, "__shadowTemplate", "DocumentItem___shadowTemplate", "get$DocumentItem___shadowTemplate", function() {
